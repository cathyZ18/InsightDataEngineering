# Source Python Code of Insight Data Engineering Code Challenge 2018
...
def main():
  ...
  prepfile = open("inactivity_period.txt","r")
  ...
  with open("log.csv", "r") as inputfile:

    # Create a new output file
    with open("sessionization.txt", "w") as outputfile:
      ...
      for line in inputfile: # Read the input file line by line
        ...
        if currentline[0] != "ip":  # Skip the first line of the input file which includes header information
          ...
          # Check if any session in the Session_Array has been inactive for more than lapse seconds
